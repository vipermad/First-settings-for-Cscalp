...
public class Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        ShowProfitType.setValue("Пункты");
...
//        ShowProfitType.valueProperty().addListener((observableValue, s, t1) -> show_profit_type =
//                ShowProfitType.getValue().equals("Пункты") ? "0" :
//                        ShowProfitType.getValue().equals("Пункты * объем") ? "1" : "2");
...
//        RulerDataType.valueProperty().addListener((observableValue, s, t1) -> ruler_data_type =
//                RulerDataType.getValue().equals("Нет") ? "0" :
//                        RulerDataType.getValue().equals("Пункты") ? "1" : "2");
        ...
        ClusterStyleColor.setValue("Баланс темный");
...
//        ClusterStyleColor.valueProperty().addListener((observableValue, s, t1) -> cluster_style_color =
//                ClusterStyleColor.getValue().equals("Баланс светлый") ? "WhiteBalance" :
//                        RulerDataType.getValue().equals("Баланс темный") ? "BlackBalance" : "Mix");
